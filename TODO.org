...
* TODO Write weft data type. (weft_t)
...
** TODO Make empty weft.
** TODO Get the top of a given yarn (weft_get)
** TODO Set the top of a given yarn (weft_set)
** TODO Extend a given yarn (weft_extend)
** TODO Does a weft cover a given atom id? (weft_covers)
** TODO Merge another weft into this one, modifying only this one. (weft_merge_into)
